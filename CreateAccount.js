function makeEnregistrementPanel(){
  ...
  Create(login.val(),password1.val(),nom.val(),prenom.val());

}

function Create(login, password,nom, prenom){

  $.ajax({
    type: "POST",
    url: "http://li328.lip6.fr:8280/gr3_michaud_jeudy/createUser",
    data:"login="+login+"&password="+password+"&nom="+nom+"&prenom="+prenom,  dataType: "json",  
    success: function(r){
